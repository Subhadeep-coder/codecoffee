...
export function ProblemsTable({ filters }: ProblemsTableProps) {
        ...
        try {
            ...
            if (filters) {
                if (filters.difficulty.length > 0) {
                    const apiDifficulties = filters.difficulty.map(d => d.toUpperCase())
            ...
            const difficultyFilter = columnFilters.find(f => f.id === "difficulty")?.value
            if (difficultyFilter) {
    ...
    useEffect(() => {
        getProblems()
    }, [pagination.pageIndex, pagination.pageSize, globalFilter, columnFilters, sorting, filters])
            ...
            <div className="flex items-center justify-between space-x-2 py-4">
                <div className="flex items-center space-x-6">
                    ...
                    <div className="text-sm text-muted-foreground">
                        ...
                        {Math.min((pagination.pageIndex + 1) * pagination.pageSize, apiPagination.total)} of{" "}
                        {apiPagination.total} results
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <Button
                            variant="outline"
                            className="hidden h-8 w-8 p-0 lg:flex"
                            onClick={() => setPagination(prev => ({ ...prev, pageIndex: apiPagination.totalPages - 1 }))}
                            disabled={!apiPagination.hasNextPage || loading}
                        >
