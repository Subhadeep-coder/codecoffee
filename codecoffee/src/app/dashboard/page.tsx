...
export default function DashboardPage() {
  ...
  const { setTokens, setUser, user, isAuthenticated, checkAuthStatus } = useAuthStore()
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      const stats: DashboardStats = {
        ...
        joinDate: new Date(userData.createdAt).toLocaleString("default", { month: "long", year: "numeric" }),
